    ...
    function Soap_request($String_Choice, $Choice_soap){
        ...
        if ($String_Choice == "log_absen") {
            switch($Choice_soap) {
                ...
                // clear log data
                case 2 : $Soap_request = "<ClearData>
                                            <ArgComKey xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
                                                <Value xsi:type=\"xsd:integer\">3</Value>
                                            </Arg>
                                        </ClearData>"; break;
                default : $Soap_request = ""; break;
            }
        }
        if ($String_Choice == "sidik_jari") {
            switch($Choice_soap)  {
                // download sidik jari
                case 1 : $Soap_request = "<GetUserTemplate>
                                            <ArgComKey xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
                                                <PIN xsi:type=\"xsd:integer\">".$id."</PIN>
                                                <FingerID xsi:type=\"xsd:integer\">".$fn."</FingerID>
                                            </Arg>
                                        </GetUserTemplate>"; break;
                // upload sidik jari
                case 2 : $Soap_request = "<SetUserTemplate>
                                            <ArgComKey xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
                                                <PIN xsi:type=\"xsd:integer\">".$id."</PIN>
                                                <FingerID xsi:type=\"xsd:integer\">".$fn."</FingerID>
                                        ...
                                        </SetUserTemplate>"; break;
                // hapus sidik jari
                case 3 : $Soap_request = "<DeleteTemplate>
                                            <ArgComKey xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
                                                <PIN xsi:type=\"xsd:integer\">".$id."</PIN>
                                            </Arg>
                                        </DeleteTemplate>"; break;
                default : $Soap_request = ""; break;
            }
        }
        ...
        if ($String_Choice == "user_data") {
            switch($Choice_soap) {
                // Upload nama
                case 1 : $Soap_request = "<SetUserInfo>
                                            <ArgComKey Xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
                                                <PIN>".$id."</PIN>
                                                <Name>".$name."</Name>
                ...
                // Delete user
                case 2 : $Soap_request = "<DeleteUser>
                                            <ArgComKey xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
                                                <PIN xsi:type=\"xsd:integer\">".$id."</PIN>
                                            </Arg>
        ...
        if ($String_Choice == "device") {
            switch($Choice_soap) {
                // restart device
                case 1 : $Soap_request = "<Restart>
                                            <ArgComKey Xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                        </Restart>"; break;
                //sync time
                case 2 : $Soap_request = "<SetDate>
                                            <ArgComKey xsi:type=\"xsd:integer\">".$Key."</ArgComKey>
                                            <Arg>
